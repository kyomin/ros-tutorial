...
/*
    메시지 콜백 함수로써, 아래 메인 함수에서 설정한 ros_tutorial_msg라는 이름의 토픽
...
int main(int argc, char** argv) {       // 서브스크라이버 노드 메인 함수
    ...
    /*
        ...
        서브스크라이버 ros_tutorial_sub을 작성한다.
    ...
    */
    ...
    /*
        콜백함수 호출을 위한 함수로써, 메시지가 수신되기를 대기한다.
        수신되었을 경우 콜백함수를 실행한다.
    */
    ros::spin();
